                                ...
                                <div class="post-meta">
                                    ...
                                    <div class="newspaper-post-like d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center post-like--comments">
                                            <a href="#"  class="post-like"><img id="like" src="img/core-img/like.png" alt=""> <span id="like1">{{$ne->like}}</span></a>
                                            <a href="#" class="post-comment"><img src="img/core-img/chat.png" alt=""> <span></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="single-blog-post style-3 mb-80">
                                    ...
                                    <div class="post-data">
                                        <a href="{{route('sigle',['id'=>$other->id])}}" class="post-catagory">{{$other->title}}</a>
                                        <a href="{{route('sigle',['id'=>$other->id])}}" class="post-title">
                                            <h6>{!! $other->summary !!}</h6>
                                        </a>
                                        <div class="post-meta d-flex align-items-center">
                                            <a href="#" class="post-like"><img src="img/core-img/like.png" alt=""> <span>{{$other->like}}</span></a>
